    ...
    try {
      ...
      if (response.ok && data.matches && data.matches.length > 0) {
        setMessages((prev) => [
          ...
          {
            type: 'bot',
            text: data.matches[0], // Show only the best answer
          },
        ]);
      } else {
        setMessages((prev) => [
          ...prev,
          { type: 'bot', text: 'No matching content found in your document.' },
        ]);
      }
    } catch (error) {
      setMessages((prev) => [
        ...
        <div className="upload-page">
          <div className="upload-container">
            <div className="upload-header">
              <h1>Document Q&A</h1>
              <p>Upload any file and ask questions to extract exact answers</p>
            </div>
        ...
        <div className="chat-page">
          <div className="chat-header">
            <div className="header-left">
              <h3>Document Q&A</h3>
              <p className="file-info">{uploadedFileName} • Semantic Search</p>
            </div>
